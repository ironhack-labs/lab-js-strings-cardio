...
// Your code here...
console.log(`${string2[2]}${string2.charAt(string2.length - 1)}${string2.charAt(string2.length - 1)}${string2.charAt(string2.length - 2)}`);
...
// Your code here...
let stringThree = `${string3.repeat(4)} Batman!`;
